...
import { Clock, CheckCircle, Building2, LayoutList } from "lucide-react";
    ...
    <div style={{ fontFamily: "'DM Sans',system-ui,sans-serif", display: "flex", flexDirection: "column", gap: 14 }}>
      ...
      <div className="fa fa1" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 12 }}>
        {[
          ...
          { label: "Validés",     value: validatedCount, Icon: CheckCircle,  color: "#02AFCF", bg: "rgba(2,175,207,.1)",  border: "rgba(2,175,207,.2)"  },
          { label: "Total",       value: totalCount,     Icon: Building2,    color: "#259FFC", bg: "rgba(37,159,252,.1)", border: "rgba(37,159,252,.2)" },
        ].map(s => (
          <div
            key={s.label}
