    ...
    <>
      ...
      <div className="rh-stats rh-card" style={{ animationDelay:".07s" }}>
        {[
          ...
          <div key={s.label} className="rh-stat" style={{ background:"white", border:`1px solid ${s.border}`, borderRadius:16, padding:"16px 18px", display:"flex", alignItems:"center", gap:12, boxShadow:"0 2px 8px rgba(5,51,102,.05)", animationDelay:`${.07 + i*.05}s`, cursor:"default", transition:"all .2s" }}>
