...
const CATEGORIES = ["Archéologie","Nature","Gastronomie","Culture","Aventure","Relaxation","Vie nocturne"];
...
export default function NouvelleExcursion() {
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="section">
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {CATEGORIES.map(c => (
                <button key={c} type="button" onClick={() => setCategories(toggle(categories, c))} style={chip(categories.includes(c))}>
                  {c}
                </button>
              ))}
            </div>
